...
public class ServerConnect
{
    ...
    public static void handleAccept(SelectionKey key) throws IOException {
        ...
        sc.register(key.selector(), SelectionKey.OP_READ, ByteBuffer.allocateDirect(BUF_SIZE));// 将 channel 注册到 selector 上
            //与Selector 一起使用时，channel必须处于 非阻塞模式下，这意味着不能将FileChannel与Selector一起使用，因为FileChannel不能切换到非阻塞模式。而套接字通道都可以
