package com.lijian.scheduledthreadpoolexecutor;
...
public class Test
{
    ...
    private static class MyTask implements Runnable {
        ...
        public MyTask(ScheduledThreadPoolExecutor stp){
            this.stp=stp;
        }
        @Override  
        public void run() {  
    ...
    private static class MyTask2 implements Runnable {
        ScheduledThreadPoolExecutor stp;
        public MyTask2(ScheduledThreadPoolExecutor stp){
            this.stp=stp;
        }
        @Override
        public void run() {
...
//            throw new RuntimeException();
    ...
    {
        stp = new ScheduledThreadPoolExecutor(2);
        MyTask mytask = new MyTask(stp);
        MyTask2 myTask2 = new MyTask2(stp);
...
//        stp.scheduleAtFixedRate(mytask, 2, 1,TimeUnit.SECONDS );
        ...
        stp.scheduleWithFixedDelay(myTask2, 2, 1, TimeUnit.SECONDS);
    }
