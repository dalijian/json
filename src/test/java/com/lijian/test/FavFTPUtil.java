...
public class FavFTPUtil {
    ...
    public static boolean uploadFile(String hostname, int port, String username, String password, String pathname, String fileName, InputStream inputStream) {
        ...
        try {
            ...
            ftpClient.setFileType(FTPClient.BINARY_FILE_TYPE); // 二进制 文件 格式

            boolean flag2 = ftpClient.changeWorkingDirectory(pathname);
            if (!flag2) {
     ...
     * @return
     */
    public static boolean downloadFileBrowser(String hostname, int port, String username, String password, String pathname, String filename) {
        boolean flag = false;
        FTPClient ftpClient = new FTPClient();
        try {
            //连接FTP服务器
...
// FavFTPUtil.downloadFile(hostname, port, username, password, pathname, filename, localpath);
    ...
    public void testDownFile() {
        String hostname = "172.19.12.221";
        int port = 21;
        String username = "ftptest";
        String password = "Test123!@#";
        String pathname = "/record/test";
        String filename = "simpleTable.docx";
        FavFTPUtil.downloadFileBrowser(hostname, port, username, password, pathname, filename);
