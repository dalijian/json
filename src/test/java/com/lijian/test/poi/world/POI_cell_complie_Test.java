...
public class POI_cell_complie_Test {
    public static void main(String[] args) throws Exception {  
        POI_cell_complie_Test t=new POI_cell_complie_Test();
        XWPFDocument document = new XWPFDocument();  
        t.megerTableCell(document);  
        t.saveDocument(document, "e:/saveFile/temp/sys_"+ System.currentTimeMillis() + ".docx");
    }  
