...
package com.lijian.test.poi.world.examples;
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (BufferedReader modelReader = new BufferedReader(new FileReader(args[0]))) {
            ...
            try (XWPFDocument doc = new XWPFDocument()) {
                XWPFChart chart = doc.createChart(200, 200);
                setBarData(chart, chartTitle, series, categories, values1, values2);
                // save the result
                try (OutputStream out = new FileOutputStream("C:/users/lijian/desktop/bar-chart-demo-output.docx")) {
                    doc.write(out);
                }
            }
            catch(Exception e)
